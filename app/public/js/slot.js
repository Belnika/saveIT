...
function initSlot() {
    ...
    */
    ...
    var win = [];
    win[172] = win[344] = win[516] = win[688] = false;
    win[0] = win[86] = win[258] =  win[430] = win[602] = true;
    ...
    */
    Slot.prototype.finalPos = function() {
        ...
        var multipleCanvas = pos % imgHeight ; 

        var canvas = Math.floor(multipleCanvas / 86); // assume 86px for each img  
        best = posArr[canvas];
        this.pos = posArr[canvas];
    ...
    */
    ...
    function printResult() {
        var res;
        if(win[a.pos] && win[b.pos] && win[c.pos]) {
            res = "You won 1000 points !<br />Just kidding :)";
            disableControl();
        } else {
            res = "You lose :(";
        }
    ...
    */
    ...
    $('#control').click(function() {
        var x;
        if(this.innerHTML == "Bike 'n' Roll" || this.innerHTML == "Do it again !") {
            $("#result").hide();
            a.start();
            b.start();
            c.start();
            this.innerHTML = "Brake baby !";
        ...
        } else if(this.innerHTML == "Brake baby !") {
            a.stop();
            b.stop();
            c.stop();
            this.innerHTML = "Do it again !";
